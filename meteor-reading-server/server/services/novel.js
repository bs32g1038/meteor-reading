...
exports.crontabCrawler = async () => {
    ...
    crawler();
    setInterval(crawler, 1000 * 60 * 60 * 3);
};
...
exports.getNovelList = async () => {
    ...
    const data = _db.sort((a, b) => {
        return b.sumClickCount - a.sumClickCount;
    });
...
exports.getChapterDataById = async (novelId, chapterId) => {
    ...
    const [chapter] = await new ChapterCrawler().crawlChapterContent(`https://www.ddxsku.com/files/article/html/${novelId.substring(0, 2)}/${novelId}/${chapterId}.html`);
