            ...
            <div class="module-body">
                <tabs v-model="tabs1" type="card" animated>
                    <tab title="玄幻奇幻">
                        ...
                        <module-slide-novel-list :items="sliceArr(categoryRecommend.xuanhuan, 1)"></module-slide-novel-list>
                    </tab>
                    <tab title="仙侠修真">
                        <list-item :item="sliceArr(categoryRecommend.xianxia, 0, 1)"></list-item>
                        <module-slide-novel-list :items="sliceArr(categoryRecommend.xianxia, 1)"></module-slide-novel-list>
                    </tab>
                </tabs>
                <hr class="hr">
                <tabs v-model="tabs2" type="card" animated>
                    <tab title="历史军事">
                        ...
                        <module-slide-novel-list :items="sliceArr(categoryRecommend.junshi, 1)"></module-slide-novel-list>
                    </tab>
                    <tab title="都市言情">
                        <list-item :item="sliceArr(categoryRecommend.dushi, 0, 1)"></list-item>
                        <module-slide-novel-list :items="sliceArr(categoryRecommend.dushi, 1)"></module-slide-novel-list>
                    </tab>
                </tabs>
            </div>
        </div>
...
import supportAuthor from './support-author.vue';
...
export default {
    ...
    computed: {
        ...mapState('home', {
            ...
            banners: state => {
                // state.banners
                return ['/static/1.jpg', '/static/2.jpg', '/static/3.jpg', '/static/4.jpg'];
            }
        }),
        isLoading() {
