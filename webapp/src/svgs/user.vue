<template>
    <svg version="1.1" viewBox="0 0 512 512" :width="width" :height="height">
        <g>
            <path
                d="M477.7,454.8v-26c0-26.5-12.4-52-33.1-68.1c-48.2-37.4-97.3-63.5-114.5-72.2v-29.7c3.5-7.8,6.4-16.3,8.6-25.5
